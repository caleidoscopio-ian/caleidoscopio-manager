...
async function main() {
  ...
  console.log(
    `✅ Planos criados: ${basicPlan.name}, ${premiumPlan.name}, ${enterprisePlan.name}`
  );

  // 2. Criar Super Admin
  console.log("👤 Criando Super Admin2...");
  ...
  const ecommerceProduct = await prisma.product.upsert({
    ...
    create: {
      ...
      slug: "ecommerce",
      description:
        "Plataforma de e-commerce integrada para venda de produtos e serviços",
      icon: "shopping-cart",
      color: "#10b981",
  ...
  const educationalProduct = await prisma.product.upsert({
    ...
    create: {
      ...
      slug: "educational",
      description:
        "Plataforma educacional com cursos e treinamentos para profissionais de saúde",
      icon: "graduation-cap",
      color: "#3b82f6",
  ...
  const telemedicineProduct = await prisma.product.upsert({
    ...
    create: {
      ...
      slug: "telemedicine",
      description:
        "Plataforma de telemedicina para consultas online e acompanhamento remoto",
      icon: "video",
      color: "#8b5cf6",
  ...
  console.log(
    `✅ Produtos criados: ${ecommerceProduct.name}, ${educationalProduct.name}, ${telemedicineProduct.name}`
  );
